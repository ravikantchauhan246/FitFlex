...
const ExerciseCard = ({exercise,index}) => {
  ...
  return (
    <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
        ...
        <div className="grid grid-cols sm:grid-cols-4 sm:place-items-center gap-2">{['reps','rest','tempo'].map(info=>{
            return(
        ...
        <button onClick={handleSetIncrement} className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-purple-900 hover:border-purple-500 w-full  ">
